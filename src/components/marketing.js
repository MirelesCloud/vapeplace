    ...
    <div className="row mb-5">
      <div className="col-lg-4 mb-4">
        <div className="card h-100">
          <h4 className="card-header text-light bg-success">What is CBD</h4>
      ...
      <div className="col-lg-4 mb-4">
        <div className="card h-100">
          <h4 className="card-header text-light bg-success">How to use CBD</h4>
          <div className="card-body">
            <p className="card-text text-justify">Each full-spectrum hemp product is designed for different uses. CBD Drip Gold, Platinum, and Onyx are designed primarily for use in your favorite E-Liquid. Our RixMix brand can be used in your vape or a sublingual (under the tongue). ECOCaps and ECOGels are your daily use full-spectrum pill form hemp product to help bring balance and homeostasis. ECODrops are engineered with a particular focus in mind. When you need an additional boost, focus, relief or you just need to relax and dream away, use our ECODrops. We also offer a hemp extract in isolate form called ECOShot Energy & Relax as a quick energy boost or as a stress reliever.</p>
          </div>
          <div className="card-footer bg-success">
